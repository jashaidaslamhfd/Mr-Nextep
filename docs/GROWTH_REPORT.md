...
_Generated 2026-07-29 06:57 UTC · policy 2026.07 (verified 2026-07-29)_
...
```
SKILLOR algorithm policy 2026.07 (verified 2026-07-29)

- YouTube Shorts: 30-42s (ideal 36s), hook <= 3.2s, 3-4 hashtags, gate 50% AVP
- Facebook Reels: 20-32s (ideal 27s), hook <= 3.0s, 2-3 hashtags, gate 72% AVP
- Instagram Reels: 18-30s (ideal 26s), hook <= 2.8s, 3-5 hashtags, gate 70% AVP

Script budget: 75-110 words at 2.62 w/s (hook 4-7 words).
